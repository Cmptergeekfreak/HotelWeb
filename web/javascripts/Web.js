...
$(document).ready(function () {
    ...
    $('.selectable').click(function () {
        var id = $(this).attr('id');
        $('#hotelForm').attr('action', "/HotelWeb/hotelweb?type=view&hotel_id=" + id + "&arraySpace=" + $(this).attr("arraySpace"));
        $('#hotelForm').submit();
    });
    ...
    $('#insertBtn').click(function () {
        ...
        $('#hotelForm').attr('action', "../HotelWeb/hotelweb?type=create&hotel_id=0");
...
//    });
    ...
    $('#updateBtn').click(function () {
        ...
        if (type === "view" && !$('#hotelForm').hasClass('cleared')) {
            $('#hotelForm').attr('action', "/HotelWeb/hotelweb?type=update&hotel_id=" + id + "&arraySpace=" + $('#' + id).attr("arraySpace"));
            $('#hotelForm').submit();
        } else {
            $('#error').removeClass('hidden');
    ...
    $('#deleteBtn').click(function () {
        ...
        if ((type === "view" || type === "update") && !$('#hotelForm').hasClass('cleared')) {
            $('#hotelForm').attr('action', "/HotelWeb/hotelweb?type=delete&hotel_id=" + id + "&arraySpace=" + $('#' + id).attr("arraySpace"));
            $('#hotelForm').submit();
        } else {
            $('#error').removeClass('hidden');
